...
- Decision threshold: 0.5578610904 (maximum validation F1)
...
| --- | --- | ---: |
| lightgbm | trained | 0.3940470387483796 |
| xgboost | trained | 0.32930909521374263 |

## Champion Metrics

| Split | Precision | Recall | F1 | PR-AUC | FPR | FNR |
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| Validation | 0.366231 | 0.510991 | 0.426667 | 0.394047 | 0.059879 | 0.489009 |
| Test | 0.246877 | 0.582719 | 0.346819 | 0.34609450899231975 | 0.10217483406298546 | 0.41728091728091726 |
