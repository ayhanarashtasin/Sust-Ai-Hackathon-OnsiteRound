...
const alertSchema = new mongoose.Schema(
  {
    ...
    subtype: {
      ...
      enum: [
        ...
        'missing_feed',
        'balance_mismatch',
        'model_liquidity_risk',
        'model_unusual_review',
      ],
      required: true,
    },
    ...
    dataConfidence: { type: Number, min: 0, max: 1, default: null },
    riskBand: { type: String, enum: ['low', 'medium', 'high', 'critical', 'unknown'], default: 'unknown' },
    modelType: { type: String, default: null },
    modelVersion: { type: String, default: null },
    modelProbability: { type: Number, min: 0, max: 1, default: null },
    modelThreshold: { type: Number, min: 0, max: 1, default: null },
    decisionMode: { type: String, enum: ['critical_override', 'model_rule_agreement', 'model_only', 'rule_only', 'none'], default: 'none' },
    featureSchemaVersion: { type: String, default: null },
    decisionSource: { type: String, enum: ['hybrid', 'model', 'rules', 'rules_only'], default: 'rules_only' },
    triggeredRules: { type: [Object], default: [] },
    dataFreshness: { type: Object, default: {} },
    predictionHorizonMin: { type: Number, default: null },
